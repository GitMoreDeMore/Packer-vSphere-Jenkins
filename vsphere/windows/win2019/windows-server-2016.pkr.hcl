locals {
  ...
  iso_paths         = ["[${var.vsphere_win_datastore}] ISO/windows/SW_DVD9_Win_Server_STD_CORE_2019_1809.18_64Bit_English_DC_STD_MLF_X22-74330.ISO", "[] /vmimages/tools-isoimages/windows.iso"]
}
