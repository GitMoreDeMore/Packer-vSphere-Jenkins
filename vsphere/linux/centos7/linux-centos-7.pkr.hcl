locals {
  ...
  iso_paths         = ["[${var.vsphere_lin_datastore}] ISO/linux/CentOS-7-x86_64-DVD-2009.iso"]
}
...
source "vsphere-iso" "linux-centos" {
  ...
  cd_content = {
    "/ks.cfg" = templatefile("../../../scripts/ks-templates/centos-ks.pkrtpl.hcl", {
